...
public class TPAHereCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        TPRequest.getTpRequests().put(target.getName(), new TPRequest(sender.getName(), target.getName(), TPRequest.TPType.TPAHERE));
        Lang.TPAHERE_SENT.send(sender, target.getName());
        Lang.TPAHERE_RECEIVED.send(target, sender.getName());
